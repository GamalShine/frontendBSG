...
const ChatDataViewerWithReply = () => {
  ...
  const sendReply = async () => {
    ...
    try {
      ...
      console.log('🔍 Debug: Sending message with data:', {
      ...
      console.log('🔍 Debug: Response from chatService:', response)
              ...
              try {
                ...
                if (retryResponse.success) {
                  ...
                  if (retryAttempt < maxRetries) {
                    ...
                    toast.warning('Pesan mungkin tidak tersimpan di server')
      ...
      if (error.response && error.response.status === 500) {
        toast.error('Server sedang mengalami masalah. Pesan akan dikirim ulang secara otomatis.')
        ...
        setTimeout(async () => {
          try {
            ...
            if (retryResponse.success) {
              toast.success('Pesan berhasil dikirim setelah retry!')
              await loadRoomMessages(selectedRoom)
            } else {
              toast.warning('Pesan mungkin tidak tersimpan di server')
            }
...
export default ChatDataViewerWithReply 