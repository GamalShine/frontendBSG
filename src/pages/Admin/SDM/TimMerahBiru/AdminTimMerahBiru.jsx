...
const AdminTimMerahBiru = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="p-0">
        <div className="bg-white rounded-none md:rounded-xl shadow-sm border border-gray-100 my-0 md:my-4">
          <div className="px-4 md:px-6 py-2 md:py-4">
            <div className={`grid grid-cols-1 md:grid-cols-1 gap-4`}>
              <div>
                <label className="hidden md:block text-xs font-medium text-gray-600 mb-1">Cari</label>
      ...
      <Dialog open={showForm} onOpenChange={setShowForm}>
        <DialogContent className="w-full md:max-w-lg p-0 overflow-hidden rounded-t-2xl md:rounded-2xl border border-gray-200">
          {/* Header Modal */}
          <div className="relative flex items-center justify-center px-4 py-3 border-b border-gray-200 bg-white text-gray-900 sticky top-0 z-10">
            <h3 className="text-base md:text-xl font-semibold leading-tight text-center">Tambah Tim {activeTab === 'merah' ? 'Merah' : 'Biru'}</h3>
            <button
              onClick={() => setShowForm(false)}
              className="absolute right-2 md:right-3 p-2 text-gray-500 hover:text-gray-700 rounded-lg transition-colors"
              aria-label="Tutup"
            >
              ✕
            </button>
      ...
      <Dialog open={showEditForm} onOpenChange={setShowEditForm}>
        <DialogContent className="w-full md:max-w-lg p-0 overflow-hidden rounded-t-2xl md:rounded-2xl border border-gray-200">
          {/* Header Modal */}
          <div className="relative flex items-center justify-center px-4 py-3 border-b border-gray-200 bg-white text-gray-900 sticky top-0 z-10">
            <h3 className="text-base md:text-xl font-semibold leading-tight text-center">Edit Tim {activeTab === 'merah' ? 'Merah' : 'Biru'}</h3>
            <button
