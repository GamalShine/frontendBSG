                                  ...
                                  {(jab.children || []).map(emp => (
                                    <div key={emp.id} className="px-3 py-3 flex items-center justify-between">
                                      ...
                                      <div className="flex items-center gap-2">
                                        ...
                                        <button onClick={() => navigate(`/admin/sdm/tim/${emp.id}`)} className="text-gray-600 hover:text-gray-800 text-sm">Buka Halaman</button>
                                      </div>
                                    </div>
                                  ))}
                                </div>
          ...
          <div className="relative z-10 w-full max-w-4xl bg-white rounded-2xl shadow-2xl border flex flex-col max-h-[92vh] overflow-hidden">
            ...
            <div className="p-0 border-t bg-white">
              <div className="grid grid-cols-2 gap-2 px-2 py-2">
                ...
                <button className="w-full py-3 bg-red-700 text-white font-semibold hover:bg-red-800 transition-colors rounded-lg" onClick={() => navigate(`/admin/sdm/tim/${selected?.id}`)}>Buka Halaman</button>
              </div>
            </div>
          </div>
        </div>
