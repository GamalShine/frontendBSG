          ...
          <div className="bg-white border rounded-lg shadow-sm order-2">
            <div className="px-4 py-3 border-b bg-red-700 text-white flex items-center justify-between">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-3 py-2 bg-white text-red-700 border border-red-600 rounded-lg hover:bg-red-50 md:font-semibold"
              >
