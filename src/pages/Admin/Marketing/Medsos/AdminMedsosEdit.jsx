...
const AdminMedsosEdit = () => {
  ...
  const handleEditorChange = (e) => setEditorHtml(e.target.innerHTML);
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (!isi || isi.length < 5) { toast.error('Isi laporan terlalu pendek'); setSaving(false); return; }
            ...
            {loading ? (
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div contentEditable onInput={handleEditorChange} onPaste={handlePaste} className="w-full border rounded px-3 py-2 min-h-56 bg-white focus:outline-none" style={{ whiteSpace: 'pre-wrap' }} dangerouslySetInnerHTML={{ __html: editorHtml }} />
                </div>
