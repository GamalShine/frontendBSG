        ...
        {view === 'months' && (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2">
            ...
            {!loading.months && !error.months && months.map((mNum) => {
              ...
              return (
                <div key={`${selectedYear}-${mNum}`} className="group p-4 bg-white cursor-pointer ring-1 ring-gray-200 hover:ring-red-300 hover:shadow transition-all" onClick={() => openMonth(idx)}>
                  <div className="flex items-center space-x-2">
                    <FolderIcon />
                    <div>
