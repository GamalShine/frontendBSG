...
const AdminMedsosKOLForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Data KOL berhasil ditambahkan');
      navigate('/admin/marketing/medsos');
    } catch (err) {
      console.error(err);
      alert('Gagal menambahkan data KOL');
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-900">Tambah Data KOL</h1>
            <p className="text-gray-600">Input data Key Opinion Leader</p>
          </div>
        </div>
      </div>
...
export default AdminMedsosKOLForm;
