...
const OwnerTimMerahList = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Tim Merah</h1>
        <p className="text-gray-600">Kelola data tim merah</p>
      </div>
              ...
              {loading ? (
                ...
                timMerah.map((tim) => (
                  <tr key={tim.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(tim.status)}`}>
                        {getStatusText(tim.status)}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <Link
                          to={`/owner/sdm/tim/merah/edit/${tim.id}`}
...
export default OwnerTimMerahList
