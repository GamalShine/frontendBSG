      ...
      <div className="bg-red-800 text-white px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => navigate('/owner/operasional/sewa')} className="px-4 py-2 rounded-lg border border-white/60 hover:bg-white/10">Kembali</button>
          </div>
        </div>
      </div>
...
export default OwnerDataSewaDetail;
