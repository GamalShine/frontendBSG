...
const OwnerKomplainList = () => {
  ...
  const handleEdit = (id) => {
    ...
    navigate(`/owner/operasional/komplain/${id}/edit`);
  };
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-900">Daftar Komplain - Owner</h1>
        <Button 
          className="bg-blue-600 hover:bg-blue-700"
          onClick={() => navigate('/owner/operasional/komplain/new')}
        >
...
export default OwnerKomplainList;
