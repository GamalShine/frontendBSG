    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/owner/tugas" className="text-red-600 hover:text-red-700 mt-2 inline-block">
...
export default OwnerTugasDetail
