  ...
  useEffect(() => {
    const fetchAturan = async () => {
      try {
        ...
        const res = await aturanService.listDivisi();
      ...
      <div className="bg-red-800 text-white px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-red-100">Divisi - SDM</p>
          </div>
        </div>
      </div>
...
export default DivisiSopAturan;
